				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>$.$pro_price.00
									<button pid='$pro_id'  style='float:right;' id='product' class='btn btn-success btn-xs'>Añadir al carrito</button>
								</div>
							</div>
						</div>	
	...
	if(isset($_POST["addToProduct"])){
		...
		if($count > 0){
			...
			echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b> Registrate Primero, luego podras agregar un producto a tu carrito</b>
					</div>
				";
		}
	...
	if($run_query){
		echo "
			<div class='alert alert-danger'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>El producto se quitara del carrito!</b>
			</div>
		";
	}
}
